...
GFC_VECTOR_32 *
internal_pack_v32 (gfc_array_v32 * source)
{
  ...
  index_type dim;
  index_type ssize;
  const GFC_VECTOR_32 *src;
  GFC_VECTOR_32 * restrict dest;
  GFC_VECTOR_32 *destptr;
  int n;
  int packed;
  ...
  destptr = (GFC_VECTOR_32 *)memalign (32, ssize * sizeof (GFC_VECTOR_32));
  dest = destptr;
  src = source->data;
  stride0 = stride[0];
