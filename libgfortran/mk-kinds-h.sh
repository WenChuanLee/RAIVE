...
# For vector type node
echo "#define HAVE_GFC_VECTOR_32"
echo "typedef double GFC_VECTOR_32[4];" 
echo "#define GFC_VECTOR_32_HUGE 1.7976931348623157e308"
echo "#define GFC_VECTOR_32_DIGITS 53"
echo "#define GFC_VECTOR_32_RADIX 2"
echo ""
