...
#ifdef HAVE_GFC_VECTOR_32
typedef GFC_ARRAY_DESCRIPTOR (GFC_MAX_DIMENSIONS, GFC_VECTOR_32) gfc_array_v32;
#endif
...
#ifdef HAVE_GFC_VECTOR_32
#define GFC_DTYPE_VECTOR_32 ((BT_VECTOR << GFC_DTYPE_TYPE_SHIFT) \
   | (sizeof(GFC_VECTOR_32) << GFC_DTYPE_SIZE_SHIFT))
#endif
...
#ifdef HAVE_GFC_VECTOR_32
#define GFC_UNALIGNED_32(x) (((uintptr_t)(x)) & \
			     (__alignof__(GFC_VECTOR_32) - 1))
#endif
...
#ifdef HAVE_GFC_VECTOR_32
GFC_VECTOR_32 *internal_pack_v32 (gfc_array_v32 *);
internal_proto(internal_pack_v32);
#endif
...
#ifdef HAVE_GFC_VECTOR_32
extern void internal_unpack_v32 (gfc_array_v32 *, const GFC_VECTOR_32 *);
internal_proto(internal_unpack_v32);
#endif
...
#ifdef HAVE_GFC_VECTOR_32
void cshift0_v32 (gfc_array_v32 *, const gfc_array_v32 *, ptrdiff_t, int);
internal_proto(cshift0_v32);
#endif
