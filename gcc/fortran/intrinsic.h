...
gfc_try gfc_check_fn_rcv (gfc_expr *);
gfc_try gfc_check_fn_rc2008 (gfc_expr *);
gfc_try gfc_check_fn_v (gfc_expr *);
gfc_try gfc_check_fn_v_v (gfc_expr *, gfc_expr *);
...
gfc_try gfc_check_mm256_get_pd (gfc_expr *, gfc_expr *);
gfc_try gfc_check_mm256_set_pd (gfc_expr *, gfc_expr *, gfc_expr *);
...
gfc_expr *gfc_simplify_dummy (gfc_expr *);
gfc_expr *gfc_simplify_dummy2 (gfc_expr *, gfc_expr *);
gfc_expr *gfc_simplify_mm256_get_pd(gfc_expr *, gfc_expr *);
gfc_expr *gfc_simplify_mm256_set_pd(gfc_expr *, gfc_expr *, gfc_expr *);
...
void gfc_resolve_sqrtv (gfc_expr *, gfc_expr *);
void gfc_resolve_dummy (gfc_expr *, gfc_expr *);
void gfc_resolve_dummy2 (gfc_expr *, gfc_expr *, gfc_expr *);
void gfc_resolve_mm256_get_pd(gfc_expr *, gfc_expr *, gfc_expr *);
void gfc_resolve_mm256_set_pd(gfc_expr *, gfc_expr *, gfc_expr *, gfc_expr *);
