...
tree mm256_sqrtv_fndecl;
tree mm256_pow_pd_fndecl;
tree mm256_pow_pdi_fndecl;
tree mm256_fabs_pd_fndecl;
...
gfc_get_symbol_decl (gfc_symbol * sym)
{
  ...
  if (TREE_STATIC (decl)
	  ...
	  || !sym->attr.codimension || sym->attr.allocatable))
    {
      fprintf (stderr, "dim=%d, codim=%d, allocatable=%d, proc_pointer=%d\n",
          sym->attr.dimension,
