...
gfc_expr *gfc_convert_vector (gfc_expr *, gfc_expr *, gfc_expr *, gfc_expr *, int);
...
gfc_expr *gfc_int2vector (gfc_expr *, int);
gfc_expr *gfc_int2complexvec (gfc_expr *, int);
gfc_expr *gfc_real2int (gfc_expr *, int);
gfc_expr *gfc_real2real (gfc_expr *, int);
gfc_expr *gfc_real2complex (gfc_expr *, int);
gfc_expr *gfc_real2vector (gfc_expr *, int);
gfc_expr *gfc_real2complexvec (gfc_expr *, int);
