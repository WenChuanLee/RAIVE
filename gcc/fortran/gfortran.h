...
{ EXPR_OP = 1, EXPR_FUNCTION, EXPR_CONSTANT, EXPR_VARIABLE,
  EXPR_SUBSTRING, EXPR_STRUCTURE, EXPR_ARRAY, EXPR_VECTOR, EXPR_NULL, EXPR_COMPCALL, EXPR_PPC
}
expr_t;
...
enum gfc_isym_id
{
  ...
  GFC_ISYM_YN,
  GFC_ISYM_YN2,
  GFC_ISYM_MM256_GET_PD,
  GFC_ISYM_MM256_SET_PD,

#define DEF_IX86_BUILTIN(name) GFC_ISYM_## name,
#include "../config/i386/ix86-ssemmx.def"
...
/* Expression nodes.  The expression node types deserve explanations,
   ...
   EXPR_VECTOR     A vector constructor.
...
extern gfc_real_info gfc_vector_kinds[];
extern gfc_real_info gfc_complexvec_kinds[];
...
extern int gfc_default_vector_kind;
extern int gfc_default_complexvec_kind;
...
gfc_expr *gfc_get_vector_expr (bt type, int kind, locus *);
...
int gfc_vector_ts (gfc_typespec *);
