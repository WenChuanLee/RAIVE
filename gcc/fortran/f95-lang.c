...
gfc_create_decls (void)
{
  ...
  if (flag_lineage || flag_lineage_fp)
    lineage_fp_init ();
  /* LINEAGEEND */
...
#undef DEF_POINTER_TYPE
  ...
  func_vector_vector = build_function_type_list (v4df_type_node,
...
/*  gfc_define_builtin ("__builtin_sqrtv", func_vector_vector,
		      BUILT_IN_SQRTV, "sqrtv", ATTR_CONST_NOTHROW_LEAF_LIST); */
...
#define build_function_type_2(rtype, arg1, arg2) \
  ...
  /* TODO: accommmodate the power function for Vector*32 at a better place. */
  {
    tree mm256_pow_pd_fntype;
    tree mm256_pow_pdi_fntype;

    mm256_pow_pd_fntype = build_function_type_2 (v4df_type_node,
        v4df_type_node, v4df_type_node);
    mm256_pow_pd_fndecl = lineage_make_builtin (FUNCTION_DECL,
        "vmm256_pow_pd", mm256_pow_pd_fntype);

    mm256_pow_pdi_fntype = build_function_type_2 (v4df_type_node,
        v4df_type_node, integer_type_node);
    mm256_pow_pdi_fndecl = lineage_make_builtin (FUNCTION_DECL,
        "vmm256_pow_pdi", mm256_pow_pdi_fntype);
  }

  {
    tree mm256_fabs_pd_fntype;

    mm256_fabs_pd_fntype = build_function_type_1 (v4df_type_node,
        v4df_type_node);

    mm256_fabs_pd_fndecl = lineage_make_builtin (FUNCTION_DECL,
        "vmm256_fabs_pd", mm256_fabs_pd_fntype);
  }
